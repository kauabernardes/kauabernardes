...
- 🎓 **Formação:** Técnico em Informática para Internet integrado ao Ensino Médio — IFES Campus Serra.
- 🔬 **Pesquisa:** Bolsista de Iniciação Científica Júnior nas áreas de Robótica e Ciência da Computação.
- 🤖 **Hard Tech:** Desenvolvimento de projetos de robótica competitiva e IoT utilizando microcontroladores.
- 💼 **Experiência Prática:** Atuação no desenvolvimento de sistemas de gestão, scoreboards em tempo real para torneios e plataformas educacionais/comunitárias.
...
### **Mobile**
- **Android Nativo:** Kotlin, XML Layouts, Fragments

### **Robótica & Hardware**
- **Embarcados:** ESP32, Arduino (C/C++)
- **Prototipagem:** Conectividade Bluetooth/Wi-Fi e Impressão 3D (Bambu Lab A1)
